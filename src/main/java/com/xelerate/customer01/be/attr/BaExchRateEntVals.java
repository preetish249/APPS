...
import com.xelerate.customer01.be.attr.BaExchRateEnt;
import com.xelerate.be.core.BEVals;

public class BaExchRateEntVals extends ValidatorNode implements ValidatorNodeIface {
  public void validate(BaExchRateEnt BEData) throws XException {
    // Call Super Method...
